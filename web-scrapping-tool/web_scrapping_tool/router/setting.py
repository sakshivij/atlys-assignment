...
async def create_setting(setting: SettingCreate, service: SettingService = Depends(get_setting_service)):
...
async def update_setting(setting_id: str, setting: SettingCreate, service: SettingService = Depends(get_setting_service)):
...
async def delete_setting(setting_id: str, service: SettingService = Depends(get_setting_service)):
